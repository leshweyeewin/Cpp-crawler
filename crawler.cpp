/* 
    ...
    Introduce some delay (3s) between requests to avoid misinterpreting crawler as a DOS attack.
...
void* clientThread ( void *args ) {
    ...
    int sock, bytes_sent, bytes_received, message_size, data_size;
